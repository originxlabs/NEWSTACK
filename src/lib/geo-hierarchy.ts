  ...
  },
  {
    ...
    countries: [
      { id: "gb", name: "United Kingdom", code: "GB", flag: "🇬🇧", states: [
        { id: "england", name: "England", cities: [
          { id: "london", name: "London", isCapital: true, localities: [
            ...
            { id: "shoreditch", name: "Shoreditch", type: "district" },
            { id: "kensington", name: "Kensington", type: "district" },
            { id: "chelsea", name: "Chelsea", type: "district" },
            { id: "camden", name: "Camden", type: "district" },
            { id: "greenwich", name: "Greenwich", type: "district" },
          ]},
          { id: "manchester", name: "Manchester", localities: [
            { id: "salford-quays", name: "Salford Quays", type: "hub" },
            { id: "northern-quarter", name: "Northern Quarter", type: "district" },
            { id: "spinningfields", name: "Spinningfields", type: "hub" },
          ]},
          { id: "birmingham", name: "Birmingham", localities: [
            { id: "jewellery-quarter", name: "Jewellery Quarter", type: "district" },
            { id: "digbeth", name: "Digbeth", type: "district" },
          ]},
          { id: "leeds", name: "Leeds", localities: [{ id: "leeds-centre", name: "City Centre", type: "hub" }] },
          { id: "liverpool", name: "Liverpool", localities: [{ id: "liverpool-docks", name: "Albert Dock", type: "hub" }] },
          { id: "bristol", name: "Bristol", localities: [{ id: "harbourside", name: "Harbourside", type: "hub" }] },
          { id: "sheffield", name: "Sheffield", localities: [] },
          { id: "newcastle", name: "Newcastle", localities: [{ id: "quayside", name: "Quayside", type: "hub" }] },
          { id: "nottingham", name: "Nottingham", localities: [] },
          { id: "leicester", name: "Leicester", localities: [] },
          { id: "cambridge", name: "Cambridge", localities: [{ id: "cambridge-tech", name: "Cambridge Science Park", type: "hub" }] },
          { id: "oxford", name: "Oxford", localities: [] },
          { id: "reading", name: "Reading", localities: [{ id: "thames-valley-park", name: "Thames Valley Park", type: "hub" }] },
        ]},
        { id: "scotland", name: "Scotland", cities: [
          { id: "edinburgh", name: "Edinburgh", isCapital: true, localities: [
            { id: "old-town", name: "Old Town", type: "district" },
            { id: "leith", name: "Leith", type: "district" },
          ]},
          { id: "glasgow", name: "Glasgow", localities: [
            { id: "merchant-city", name: "Merchant City", type: "district" },
            { id: "west-end", name: "West End", type: "district" },
          ]},
          { id: "aberdeen", name: "Aberdeen", localities: [] },
          { id: "dundee", name: "Dundee", localities: [] },
          { id: "inverness", name: "Inverness", localities: [] },
        ]},
        { id: "wales", name: "Wales", cities: [
          { id: "cardiff", name: "Cardiff", isCapital: true, localities: [{ id: "cardiff-bay", name: "Cardiff Bay", type: "hub" }] },
          { id: "swansea", name: "Swansea", localities: [] },
          { id: "newport", name: "Newport", localities: [] },
        ]},
        { id: "northern-ireland", name: "Northern Ireland", cities: [
          { id: "belfast", name: "Belfast", isCapital: true, localities: [{ id: "titanic-quarter", name: "Titanic Quarter", type: "hub" }] },
          { id: "derry", name: "Derry", localities: [] },
        ]},
      ]},
      { id: "de", name: "Germany", code: "DE", flag: "🇩🇪", states: [
        { id: "berlin-s", name: "Berlin", cities: [{ id: "berlin", name: "Berlin", isCapital: true, localities: [
          { id: "mitte", name: "Mitte", type: "hub" },
          { id: "kreuzberg", name: "Kreuzberg", type: "district" },
          { id: "prenzlauer-berg", name: "Prenzlauer Berg", type: "district" },
          { id: "charlottenburg", name: "Charlottenburg", type: "district" },
          { id: "friedrichshain", name: "Friedrichshain", type: "district" },
        ]}] },
        { id: "bavaria", name: "Bavaria", cities: [
          { id: "munich", name: "Munich", localities: [
            { id: "schwabing", name: "Schwabing", type: "district" },
            { id: "maxvorstadt", name: "Maxvorstadt", type: "district" },
            { id: "bogenhausen", name: "Bogenhausen", type: "hub" },
          ]},
          { id: "nuremberg", name: "Nuremberg", localities: [] },
          { id: "augsburg", name: "Augsburg", localities: [] },
          { id: "regensburg", name: "Regensburg", localities: [] },
        ]},
        { id: "hessen", name: "Hessen", cities: [
          { id: "frankfurt", name: "Frankfurt", localities: [
            { id: "bankenviertel", name: "Bankenviertel", type: "hub" },
            { id: "sachsenhausen", name: "Sachsenhausen", type: "district" },
            { id: "westend", name: "Westend", type: "district" },
          ]},
          { id: "wiesbaden", name: "Wiesbaden", isCapital: true, localities: [] },
          { id: "kassel", name: "Kassel", localities: [] },
          { id: "darmstadt", name: "Darmstadt", localities: [] },
        ]},
        { id: "nrw", name: "North Rhine-Westphalia", cities: [
          { id: "cologne", name: "Cologne", localities: [
            { id: "koln-innenstadt", name: "Innenstadt", type: "hub" },
            { id: "ehrenfeld", name: "Ehrenfeld", type: "district" },
          ]},
          { id: "dusseldorf", name: "Düsseldorf", localities: [
            { id: "medienhafen", name: "Medienhafen", type: "hub" },
            { id: "altstadt", name: "Altstadt", type: "district" },
          ]},
          { id: "dortmund", name: "Dortmund", localities: [] },
          { id: "essen", name: "Essen", localities: [] },
          { id: "bonn", name: "Bonn", localities: [] },
          { id: "duisburg", name: "Duisburg", localities: [] },
        ]},
        { id: "hamburg-s", name: "Hamburg", cities: [{ id: "hamburg", name: "Hamburg", localities: [
          { id: "hafencity", name: "HafenCity", type: "hub" },
          { id: "altona", name: "Altona", type: "district" },
          { id: "st-pauli", name: "St. Pauli", type: "district" },
        ]}] },
        { id: "baden-wurttemberg", name: "Baden-Württemberg", cities: [
          { id: "stuttgart", name: "Stuttgart", isCapital: true, localities: [{ id: "stuttgart-mitte", name: "Stuttgart-Mitte", type: "hub" }] },
          { id: "karlsruhe", name: "Karlsruhe", localities: [] },
          { id: "mannheim", name: "Mannheim", localities: [] },
          { id: "freiburg", name: "Freiburg", localities: [] },
          { id: "heidelberg", name: "Heidelberg", localities: [] },
        ]},
        { id: "niedersachsen", name: "Lower Saxony", cities: [
          { id: "hanover", name: "Hanover", isCapital: true, localities: [] },
          { id: "braunschweig", name: "Braunschweig", localities: [] },
          { id: "oldenburg", name: "Oldenburg", localities: [] },
          { id: "wolfsburg", name: "Wolfsburg", localities: [] },
        ]},
        { id: "sachsen", name: "Saxony", cities: [
          { id: "dresden", name: "Dresden", isCapital: true, localities: [] },
          { id: "leipzig", name: "Leipzig", localities: [{ id: "plagwitz", name: "Plagwitz", type: "district" }] },
          { id: "chemnitz", name: "Chemnitz", localities: [] },
        ]},
        { id: "bremen-s", name: "Bremen", cities: [{ id: "bremen", name: "Bremen", localities: [] }] },
        { id: "schleswig-holstein", name: "Schleswig-Holstein", cities: [
          { id: "kiel", name: "Kiel", isCapital: true, localities: [] },
          { id: "lubeck", name: "Lübeck", localities: [] },
        ]},
      ]},
      { id: "fr", name: "France", code: "FR", flag: "🇫🇷", states: [
        { id: "ile-de-france", name: "Île-de-France", cities: [
          { id: "paris", name: "Paris", isCapital: true, localities: [
            { id: "la-defense", name: "La Défense", type: "hub" },
            { id: "le-marais", name: "Le Marais", type: "district" },
            { id: "montmartre", name: "Montmartre", type: "district" },
            { id: "champs-elysees", name: "Champs-Élysées", type: "hub" },
            { id: "saint-germain", name: "Saint-Germain-des-Prés", type: "district" },
            { id: "latin-quarter", name: "Latin Quarter", type: "district" },
            { id: "bastille", name: "Bastille", type: "district" },
            { id: "opera", name: "Opéra", type: "hub" },
          ]},
          { id: "versailles", name: "Versailles", localities: [] },
          { id: "boulogne", name: "Boulogne-Billancourt", localities: [] },
          { id: "saint-denis", name: "Saint-Denis", localities: [] },
        ]},
        { id: "paca", name: "Provence-Alpes-Côte d'Azur", cities: [
          { id: "marseille", name: "Marseille", localities: [
            { id: "vieux-port", name: "Vieux-Port", type: "hub" },
            { id: "la-joliette", name: "La Joliette", type: "hub" },
          ]},
          { id: "nice", name: "Nice", localities: [{ id: "promenade-anglais", name: "Promenade des Anglais", type: "hub" }] },
          { id: "cannes", name: "Cannes", localities: [{ id: "la-croisette", name: "La Croisette", type: "hub" }] },
          { id: "aix-en-provence", name: "Aix-en-Provence", localities: [] },
          { id: "antibes", name: "Antibes", localities: [] },
          { id: "toulon", name: "Toulon", localities: [] },
          { id: "avignon", name: "Avignon", localities: [] },
        ]},
        { id: "auvergne-rhone-alpes", name: "Auvergne-Rhône-Alpes", cities: [
          { id: "lyon", name: "Lyon", localities: [
            { id: "presquile", name: "Presqu'île", type: "hub" },
            { id: "croix-rousse", name: "Croix-Rousse", type: "district" },
            { id: "part-dieu", name: "Part-Dieu", type: "hub" },
            { id: "confluence", name: "Confluence", type: "hub" },
          ]},
          { id: "grenoble", name: "Grenoble", localities: [] },
          { id: "saint-etienne", name: "Saint-Étienne", localities: [] },
          { id: "annecy", name: "Annecy", localities: [] },
          { id: "clermont-ferrand", name: "Clermont-Ferrand", localities: [] },
        ]},
        { id: "nouvelle-aquitaine", name: "Nouvelle-Aquitaine", cities: [
          { id: "bordeaux", name: "Bordeaux", localities: [
            { id: "chartrons", name: "Chartrons", type: "district" },
            { id: "saint-pierre", name: "Saint-Pierre", type: "district" },
          ]},
          { id: "limoges", name: "Limoges", localities: [] },
          { id: "poitiers", name: "Poitiers", localities: [] },
          { id: "biarritz", name: "Biarritz", localities: [] },
          { id: "la-rochelle", name: "La Rochelle", localities: [] },
        ]},
        { id: "occitanie", name: "Occitanie", cities: [
          { id: "toulouse", name: "Toulouse", localities: [
            { id: "capitole", name: "Capitole", type: "hub" },
            { id: "carmes", name: "Les Carmes", type: "district" },
          ]},
          { id: "montpellier", name: "Montpellier", localities: [{ id: "antigone", name: "Antigone", type: "district" }] },
          { id: "nimes", name: "Nîmes", localities: [] },
          { id: "perpignan", name: "Perpignan", localities: [] },
        ]},
        { id: "grand-est", name: "Grand Est", cities: [
          { id: "strasbourg", name: "Strasbourg", localities: [
            { id: "petite-france", name: "Petite France", type: "district" },
            { id: "european-quarter", name: "European Quarter", type: "hub" },
          ]},
          { id: "metz", name: "Metz", localities: [] },
          { id: "nancy", name: "Nancy", localities: [] },
          { id: "reims", name: "Reims", localities: [] },
          { id: "mulhouse", name: "Mulhouse", localities: [] },
        ]},
        { id: "hauts-de-france", name: "Hauts-de-France", cities: [
          { id: "lille", name: "Lille", localities: [
            { id: "vieux-lille", name: "Vieux-Lille", type: "district" },
            { id: "euralille", name: "Euralille", type: "hub" },
          ]},
          { id: "amiens", name: "Amiens", localities: [] },
        ]},
        { id: "pays-de-la-loire", name: "Pays de la Loire", cities: [
          { id: "nantes", name: "Nantes", localities: [{ id: "ile-de-nantes", name: "Île de Nantes", type: "hub" }] },
          { id: "angers", name: "Angers", localities: [] },
          { id: "le-mans", name: "Le Mans", localities: [] },
        ]},
        { id: "bretagne", name: "Bretagne", cities: [
          { id: "rennes", name: "Rennes", localities: [] },
          { id: "brest", name: "Brest", localities: [] },
          { id: "saint-malo", name: "Saint-Malo", localities: [] },
        ]},
        { id: "normandie", name: "Normandie", cities: [
          { id: "rouen", name: "Rouen", localities: [] },
          { id: "le-havre", name: "Le Havre", localities: [] },
          { id: "caen", name: "Caen", localities: [] },
        ]},
      ]},
      { id: "it", name: "Italy", code: "IT", flag: "🇮🇹", states: [
        { id: "lazio", name: "Lazio", cities: [
          { id: "rome", name: "Rome", isCapital: true, localities: [
            { id: "trastevere", name: "Trastevere", type: "district" },
            { id: "centro-storico", name: "Centro Storico", type: "hub" },
            { id: "testaccio", name: "Testaccio", type: "district" },
            { id: "prati", name: "Prati", type: "district" },
            { id: "eur", name: "EUR", type: "hub" },
          ]},
        ]},
        { id: "lombardy", name: "Lombardy", cities: [
          { id: "milan", name: "Milan", localities: [
            { id: "porta-nuova", name: "Porta Nuova", type: "hub" },
            { id: "navigli", name: "Navigli", type: "district" },
            { id: "brera", name: "Brera", type: "district" },
            { id: "city-life", name: "CityLife", type: "hub" },
            { id: "isola", name: "Isola", type: "district" },
          ]},
          { id: "bergamo", name: "Bergamo", localities: [] },
          { id: "brescia", name: "Brescia", localities: [] },
          { id: "como", name: "Como", localities: [] },
          { id: "monza", name: "Monza", localities: [] },
        ]},
        { id: "veneto", name: "Veneto", cities: [
          { id: "venice", name: "Venice", localities: [
            { id: "san-marco", name: "San Marco", type: "hub" },
            { id: "cannaregio", name: "Cannaregio", type: "district" },
            { id: "dorsoduro", name: "Dorsoduro", type: "district" },
          ]},
          { id: "verona", name: "Verona", localities: [] },
          { id: "padua", name: "Padua", localities: [] },
          { id: "vicenza", name: "Vicenza", localities: [] },
        ]},
        { id: "tuscany", name: "Tuscany", cities: [
          { id: "florence", name: "Florence", localities: [
            { id: "santa-croce", name: "Santa Croce", type: "district" },
            { id: "oltrarno", name: "Oltrarno", type: "district" },
            { id: "san-lorenzo", name: "San Lorenzo", type: "district" },
          ]},
          { id: "pisa", name: "Pisa", localities: [] },
          { id: "siena", name: "Siena", localities: [] },
          { id: "lucca", name: "Lucca", localities: [] },
          { id: "arezzo", name: "Arezzo", localities: [] },
        ]},
        { id: "piedmont", name: "Piedmont", cities: [
          { id: "turin", name: "Turin", localities: [
            { id: "quadrilatero", name: "Quadrilatero Romano", type: "district" },
            { id: "san-salvario", name: "San Salvario", type: "district" },
            { id: "lingotto", name: "Lingotto", type: "hub" },
          ]},
          { id: "novara", name: "Novara", localities: [] },
          { id: "alessandria", name: "Alessandria", localities: [] },
        ]},
        { id: "emilia-romagna", name: "Emilia-Romagna", cities: [
          { id: "bologna", name: "Bologna", localities: [
            { id: "centro-bologna", name: "Centro", type: "hub" },
            { id: "bolognina", name: "Bolognina", type: "district" },
          ]},
          { id: "parma", name: "Parma", localities: [] },
          { id: "modena", name: "Modena", localities: [] },
          { id: "rimini", name: "Rimini", localities: [] },
          { id: "ravenna", name: "Ravenna", localities: [] },
          { id: "ferrara", name: "Ferrara", localities: [] },
        ]},
        { id: "campania", name: "Campania", cities: [
          { id: "naples", name: "Naples", localities: [
            { id: "spaccanapoli", name: "Spaccanapoli", type: "hub" },
            { id: "chiaia", name: "Chiaia", type: "district" },
            { id: "vomero", name: "Vomero", type: "district" },
          ]},
          { id: "salerno", name: "Salerno", localities: [] },
          { id: "caserta", name: "Caserta", localities: [] },
        ]},
        { id: "sicily", name: "Sicily", cities: [
          { id: "palermo", name: "Palermo", localities: [{ id: "kalsa", name: "La Kalsa", type: "district" }] },
          { id: "catania", name: "Catania", localities: [] },
          { id: "messina", name: "Messina", localities: [] },
          { id: "syracuse", name: "Syracuse", localities: [] },
          { id: "taormina", name: "Taormina", localities: [] },
        ]},
        { id: "sardinia", name: "Sardinia", cities: [
          { id: "cagliari", name: "Cagliari", localities: [] },
          { id: "sassari", name: "Sassari", localities: [] },
          { id: "olbia", name: "Olbia", localities: [] },
        ]},
        { id: "liguria", name: "Liguria", cities: [
          { id: "genoa", name: "Genoa", localities: [{ id: "porto-antico", name: "Porto Antico", type: "hub" }] },
          { id: "la-spezia", name: "La Spezia", localities: [] },
          { id: "sanremo", name: "Sanremo", localities: [] },
        ]},
        { id: "puglia", name: "Puglia", cities: [
          { id: "bari", name: "Bari", localities: [{ id: "bari-vecchia", name: "Bari Vecchia", type: "district" }] },
          { id: "lecce", name: "Lecce", localities: [] },
          { id: "taranto", name: "Taranto", localities: [] },
          { id: "brindisi", name: "Brindisi", localities: [] },
        ]},
      ]},
      { id: "es", name: "Spain", code: "ES", flag: "🇪🇸", states: [
        { id: "madrid-c", name: "Community of Madrid", cities: [
          { id: "madrid", name: "Madrid", isCapital: true, localities: [
            { id: "sol-madrid", name: "Sol", type: "hub" },
            { id: "salamanca-madrid", name: "Salamanca", type: "district" },
            { id: "chueca", name: "Chueca", type: "district" },
            { id: "malasana", name: "Malasaña", type: "district" },
            { id: "la-latina", name: "La Latina", type: "district" },
            { id: "retiro-madrid", name: "Retiro", type: "district" },
            { id: "azca", name: "AZCA", type: "hub" },
            { id: "chamberi", name: "Chamberí", type: "district" },
          ]},
          { id: "alcala-henares", name: "Alcalá de Henares", localities: [] },
          { id: "getafe", name: "Getafe", localities: [] },
        ]},
        { id: "catalonia", name: "Catalonia", cities: [
          { id: "barcelona", name: "Barcelona", localities: [
            { id: "22-at", name: "22@", type: "hub" },
            { id: "gothic-quarter", name: "Barri Gòtic", type: "district" },
            { id: "eixample", name: "Eixample", type: "district" },
            { id: "gracia", name: "Gràcia", type: "district" },
            { id: "el-born", name: "El Born", type: "district" },
            { id: "barceloneta", name: "Barceloneta", type: "district" },
            { id: "sant-marti", name: "Sant Martí", type: "hub" },
          ]},
          { id: "girona", name: "Girona", localities: [] },
          { id: "tarragona", name: "Tarragona", localities: [] },
          { id: "lleida", name: "Lleida", localities: [] },
        ]},
        { id: "andalusia", name: "Andalusia", cities: [
          { id: "seville", name: "Seville", localities: [
            { id: "triana", name: "Triana", type: "district" },
            { id: "santa-cruz-sev", name: "Santa Cruz", type: "district" },
            { id: "nervion", name: "Nervión", type: "hub" },
          ]},
          { id: "malaga", name: "Málaga", localities: [{ id: "centro-malaga", name: "Centro Histórico", type: "hub" }] },
          { id: "granada", name: "Granada", localities: [{ id: "albaicin", name: "Albaicín", type: "district" }] },
          { id: "cordoba", name: "Córdoba", localities: [] },
          { id: "cadiz", name: "Cádiz", localities: [] },
          { id: "marbella", name: "Marbella", localities: [{ id: "puerto-banus", name: "Puerto Banús", type: "hub" }] },
        ]},
        { id: "valencia-c", name: "Valencian Community", cities: [
          { id: "valencia", name: "Valencia", localities: [
            { id: "ciutat-vella", name: "Ciutat Vella", type: "hub" },
            { id: "ruzafa", name: "Ruzafa", type: "district" },
            { id: "el-cabanyal", name: "El Cabanyal", type: "district" },
          ]},
          { id: "alicante", name: "Alicante", localities: [] },
          { id: "benidorm", name: "Benidorm", localities: [] },
          { id: "castellon", name: "Castellón", localities: [] },
        ]},
        { id: "basque-country", name: "Basque Country", cities: [
          { id: "bilbao", name: "Bilbao", localities: [
            { id: "casco-viejo-bilbao", name: "Casco Viejo", type: "district" },
            { id: "abandoibarra", name: "Abandoibarra", type: "hub" },
          ]},
          { id: "san-sebastian", name: "San Sebastián", localities: [{ id: "parte-vieja", name: "Parte Vieja", type: "district" }] },
          { id: "vitoria", name: "Vitoria-Gasteiz", isCapital: true, localities: [] },
        ]},
        { id: "galicia", name: "Galicia", cities: [
          { id: "santiago-compostela", name: "Santiago de Compostela", isCapital: true, localities: [] },
          { id: "vigo", name: "Vigo", localities: [] },
          { id: "a-coruna", name: "A Coruña", localities: [] },
        ]},
        { id: "balearic-islands", name: "Balearic Islands", cities: [
          { id: "palma", name: "Palma de Mallorca", isCapital: true, localities: [{ id: "santa-catalina", name: "Santa Catalina", type: "district" }] },
          { id: "ibiza-city", name: "Ibiza City", localities: [] },
        ]},
        { id: "canary-islands", name: "Canary Islands", cities: [
          { id: "las-palmas", name: "Las Palmas de Gran Canaria", localities: [] },
          { id: "santa-cruz-tenerife", name: "Santa Cruz de Tenerife", localities: [] },
        ]},
        { id: "castile-leon", name: "Castile and León", cities: [
          { id: "valladolid", name: "Valladolid", isCapital: true, localities: [] },
          { id: "salamanca-city", name: "Salamanca", localities: [] },
          { id: "burgos", name: "Burgos", localities: [] },
          { id: "leon", name: "León", localities: [] },
        ]},
        { id: "aragon", name: "Aragon", cities: [
          { id: "zaragoza", name: "Zaragoza", isCapital: true, localities: [] },
          { id: "huesca", name: "Huesca", localities: [] },
        ]},
      ]},
  ...
  },
  {
    ...
    countries: [
      { id: "us", name: "United States", code: "US", flag: "🇺🇸", states: [
        { id: "ca-us", name: "California", code: "CA", cities: [
          { id: "sf", name: "San Francisco", localities: [
            { id: "soma", name: "SoMa", type: "hub" },
            { id: "fidi", name: "Financial District", type: "hub" },
            { id: "mission", name: "Mission District", type: "district" },
            { id: "castro", name: "Castro", type: "district" },
            { id: "north-beach", name: "North Beach", type: "district" },
          ]},
          { id: "la", name: "Los Angeles", localities: [
            { id: "hollywood", name: "Hollywood", type: "district" },
            { id: "dtla", name: "Downtown LA", type: "hub" },
            { id: "santa-monica", name: "Santa Monica", type: "district" },
            { id: "beverly-hills", name: "Beverly Hills", type: "district" },
            { id: "venice", name: "Venice", type: "district" },
            { id: "pasadena", name: "Pasadena", type: "district" },
          ]},
          { id: "sanjose", name: "San Jose", localities: [{ id: "downtown-sj", name: "Downtown", type: "hub" }] },
          { id: "san-diego", name: "San Diego", localities: [
            { id: "gaslamp", name: "Gaslamp Quarter", type: "hub" },
            { id: "la-jolla", name: "La Jolla", type: "district" },
          ]},
          { id: "sacramento", name: "Sacramento", isCapital: true, localities: [] },
          { id: "oakland", name: "Oakland", localities: [{ id: "jack-london", name: "Jack London Square", type: "hub" }] },
          { id: "fresno", name: "Fresno", localities: [] },
          { id: "irvine", name: "Irvine", localities: [] },
          { id: "palo-alto", name: "Palo Alto", localities: [{ id: "stanford", name: "Stanford", type: "hub" }] },
        ]},
        { id: "ny-us", name: "New York", code: "NY", cities: [
          { id: "nyc", name: "New York City", localities: [
            { id: "manhattan", name: "Manhattan", type: "hub" },
            { id: "wall-street", name: "Wall Street", type: "hub" },
            { id: "brooklyn", name: "Brooklyn", type: "district" },
            { id: "queens", name: "Queens", type: "district" },
            { id: "bronx", name: "The Bronx", type: "district" },
            { id: "staten-island", name: "Staten Island", type: "district" },
            { id: "midtown", name: "Midtown", type: "hub" },
            { id: "soho", name: "SoHo", type: "district" },
            { id: "tribeca", name: "Tribeca", type: "district" },
            { id: "harlem", name: "Harlem", type: "district" },
          ]},
          { id: "albany", name: "Albany", isCapital: true, localities: [] },
          { id: "buffalo", name: "Buffalo", localities: [] },
          { id: "rochester", name: "Rochester", localities: [] },
          { id: "syracuse", name: "Syracuse", localities: [] },
        ]},
        { id: "tx", name: "Texas", code: "TX", cities: [
          { id: "austin", name: "Austin", isCapital: true, localities: [
            { id: "downtown-austin", name: "Downtown", type: "hub" },
            { id: "east-austin", name: "East Austin", type: "district" },
            { id: "south-congress", name: "South Congress", type: "district" },
          ]},
          { id: "houston", name: "Houston", localities: [
            { id: "energy-corridor", name: "Energy Corridor", type: "hub" },
            { id: "downtown-houston", name: "Downtown", type: "hub" },
            { id: "galleria", name: "Galleria", type: "hub" },
            { id: "montrose", name: "Montrose", type: "district" },
          ]},
          { id: "dallas", name: "Dallas", localities: [
            { id: "downtown-dallas", name: "Downtown", type: "hub" },
            { id: "uptown-dallas", name: "Uptown", type: "hub" },
            { id: "deep-ellum", name: "Deep Ellum", type: "district" },
          ]},
          { id: "san-antonio", name: "San Antonio", localities: [{ id: "riverwalk", name: "River Walk", type: "hub" }] },
          { id: "fort-worth", name: "Fort Worth", localities: [] },
          { id: "el-paso", name: "El Paso", localities: [] },
          { id: "plano", name: "Plano", localities: [] },
        ]},
        { id: "wa-us", name: "Washington", code: "WA", cities: [
          { id: "seattle", name: "Seattle", localities: [
            { id: "south-lake-union", name: "South Lake Union", type: "hub" },
            { id: "capitol-hill-seattle", name: "Capitol Hill", type: "district" },
            { id: "belltown", name: "Belltown", type: "district" },
            { id: "fremont-seattle", name: "Fremont", type: "district" },
          ]},
          { id: "olympia", name: "Olympia", isCapital: true, localities: [] },
          { id: "tacoma", name: "Tacoma", localities: [] },
          { id: "spokane", name: "Spokane", localities: [] },
          { id: "bellevue", name: "Bellevue", localities: [{ id: "downtown-bellevue", name: "Downtown", type: "hub" }] },
          { id: "redmond", name: "Redmond", localities: [{ id: "microsoft-campus", name: "Microsoft Campus", type: "hub" }] },
        ]},
        { id: "ma", name: "Massachusetts", code: "MA", cities: [
          { id: "boston", name: "Boston", isCapital: true, localities: [
            { id: "cambridge-ma", name: "Cambridge", type: "hub" },
            { id: "back-bay", name: "Back Bay", type: "district" },
            { id: "seaport", name: "Seaport", type: "hub" },
            { id: "beacon-hill", name: "Beacon Hill", type: "district" },
            { id: "somerville", name: "Somerville", type: "district" },
          ]},
          { id: "worcester", name: "Worcester", localities: [] },
          { id: "springfield-ma", name: "Springfield", localities: [] },
        ]},
        { id: "fl", name: "Florida", code: "FL", cities: [
          { id: "miami", name: "Miami", localities: [
            { id: "brickell", name: "Brickell", type: "hub" },
            { id: "south-beach", name: "South Beach", type: "district" },
            { id: "wynwood", name: "Wynwood", type: "district" },
            { id: "coral-gables", name: "Coral Gables", type: "district" },
          ]},
          { id: "orlando", name: "Orlando", localities: [{ id: "downtown-orlando", name: "Downtown", type: "hub" }] },
          { id: "tampa", name: "Tampa", localities: [{ id: "ybor-city", name: "Ybor City", type: "district" }] },
          { id: "jacksonville", name: "Jacksonville", localities: [] },
          { id: "tallahassee", name: "Tallahassee", isCapital: true, localities: [] },
          { id: "fort-lauderdale", name: "Fort Lauderdale", localities: [] },
          { id: "west-palm-beach", name: "West Palm Beach", localities: [] },
        ]},
        { id: "il", name: "Illinois", code: "IL", cities: [
          { id: "chicago", name: "Chicago", localities: [
            { id: "loop", name: "The Loop", type: "hub" },
            { id: "magnificent-mile", name: "Magnificent Mile", type: "hub" },
            { id: "wicker-park", name: "Wicker Park", type: "district" },
            { id: "lincoln-park", name: "Lincoln Park", type: "district" },
            { id: "river-north", name: "River North", type: "district" },
          ]},
          { id: "springfield-il", name: "Springfield", isCapital: true, localities: [] },
          { id: "aurora", name: "Aurora", localities: [] },
          { id: "naperville", name: "Naperville", localities: [] },
        ]},
        { id: "dc-us", name: "Washington D.C.", code: "DC", cities: [
          { id: "washington", name: "Washington D.C.", isCapital: true, localities: [
            { id: "capitol-hill", name: "Capitol Hill", type: "capital" },
            { id: "georgetown", name: "Georgetown", type: "district" },
            { id: "dupont-circle", name: "Dupont Circle", type: "district" },
            { id: "adams-morgan", name: "Adams Morgan", type: "district" },
            { id: "foggy-bottom", name: "Foggy Bottom", type: "district" },
          ]},
        ]},
        { id: "ga-us", name: "Georgia", code: "GA", cities: [
          { id: "atlanta", name: "Atlanta", isCapital: true, localities: [
            { id: "midtown-atl", name: "Midtown", type: "hub" },
            { id: "buckhead", name: "Buckhead", type: "hub" },
            { id: "decatur", name: "Decatur", type: "district" },
          ]},
          { id: "savannah", name: "Savannah", localities: [] },
          { id: "augusta", name: "Augusta", localities: [] },
        ]},
        { id: "co", name: "Colorado", code: "CO", cities: [
          { id: "denver", name: "Denver", isCapital: true, localities: [
            { id: "lodo", name: "LoDo", type: "hub" },
            { id: "rino", name: "RiNo", type: "district" },
            { id: "cherry-creek", name: "Cherry Creek", type: "district" },
          ]},
          { id: "boulder", name: "Boulder", localities: [] },
          { id: "colorado-springs", name: "Colorado Springs", localities: [] },
        ]},
        { id: "az", name: "Arizona", code: "AZ", cities: [
          { id: "phoenix", name: "Phoenix", isCapital: true, localities: [{ id: "downtown-phx", name: "Downtown", type: "hub" }] },
          { id: "scottsdale", name: "Scottsdale", localities: [{ id: "old-town-scottsdale", name: "Old Town", type: "hub" }] },
          { id: "tucson", name: "Tucson", localities: [] },
          { id: "tempe", name: "Tempe", localities: [{ id: "asu-campus", name: "ASU Campus", type: "hub" }] },
        ]},
        { id: "pa", name: "Pennsylvania", code: "PA", cities: [
          { id: "philadelphia", name: "Philadelphia", localities: [
            { id: "center-city", name: "Center City", type: "hub" },
            { id: "old-city", name: "Old City", type: "district" },
            { id: "university-city", name: "University City", type: "hub" },
          ]},
          { id: "harrisburg", name: "Harrisburg", isCapital: true, localities: [] },
          { id: "pittsburgh", name: "Pittsburgh", localities: [
            { id: "downtown-pgh", name: "Downtown", type: "hub" },
            { id: "oakland-pgh", name: "Oakland", type: "hub" },
            { id: "strip-district", name: "Strip District", type: "district" },
          ]},
        ]},
        { id: "nv", name: "Nevada", code: "NV", cities: [
          { id: "las-vegas", name: "Las Vegas", localities: [
            { id: "strip", name: "The Strip", type: "hub" },
            { id: "downtown-vegas", name: "Downtown", type: "hub" },
            { id: "summerlin", name: "Summerlin", type: "district" },
          ]},
          { id: "reno", name: "Reno", localities: [] },
          { id: "carson-city", name: "Carson City", isCapital: true, localities: [] },
        ]},
        { id: "nc", name: "North Carolina", code: "NC", cities: [
          { id: "charlotte", name: "Charlotte", localities: [{ id: "uptown-charlotte", name: "Uptown", type: "hub" }] },
          { id: "raleigh", name: "Raleigh", isCapital: true, localities: [] },
          { id: "durham", name: "Durham", localities: [{ id: "research-triangle", name: "Research Triangle", type: "hub" }] },
          { id: "chapel-hill", name: "Chapel Hill", localities: [] },
        ]},
        { id: "mi", name: "Michigan", code: "MI", cities: [
          { id: "detroit", name: "Detroit", localities: [
            { id: "downtown-detroit", name: "Downtown", type: "hub" },
            { id: "corktown", name: "Corktown", type: "district" },
            { id: "midtown-detroit", name: "Midtown", type: "district" },
          ]},
          { id: "lansing", name: "Lansing", isCapital: true, localities: [] },
          { id: "ann-arbor", name: "Ann Arbor", localities: [{ id: "u-of-m", name: "University of Michigan", type: "hub" }] },
          { id: "grand-rapids", name: "Grand Rapids", localities: [] },
        ]},
        { id: "oh", name: "Ohio", code: "OH", cities: [
          { id: "columbus-oh", name: "Columbus", isCapital: true, localities: [{ id: "short-north", name: "Short North", type: "district" }] },
          { id: "cleveland", name: "Cleveland", localities: [{ id: "downtown-cle", name: "Downtown", type: "hub" }] },
          { id: "cincinnati", name: "Cincinnati", localities: [{ id: "over-the-rhine", name: "Over-the-Rhine", type: "district" }] },
        ]},
        { id: "nj", name: "New Jersey", code: "NJ", cities: [
          { id: "newark", name: "Newark", localities: [] },
          { id: "jersey-city", name: "Jersey City", localities: [{ id: "exchange-place", name: "Exchange Place", type: "hub" }] },
          { id: "trenton", name: "Trenton", isCapital: true, localities: [] },
          { id: "hoboken", name: "Hoboken", localities: [] },
          { id: "princeton", name: "Princeton", localities: [] },
        ]},
        { id: "md", name: "Maryland", code: "MD", cities: [
          { id: "baltimore", name: "Baltimore", localities: [
            { id: "inner-harbor", name: "Inner Harbor", type: "hub" },
            { id: "fells-point", name: "Fells Point", type: "district" },
          ]},
          { id: "annapolis", name: "Annapolis", isCapital: true, localities: [] },
          { id: "bethesda", name: "Bethesda", localities: [] },
        ]},
        { id: "va", name: "Virginia", code: "VA", cities: [
          { id: "arlington", name: "Arlington", localities: [{ id: "rosslyn", name: "Rosslyn", type: "hub" }] },
          { id: "richmond", name: "Richmond", isCapital: true, localities: [] },
          { id: "virginia-beach", name: "Virginia Beach", localities: [] },
          { id: "norfolk", name: "Norfolk", localities: [] },
          { id: "alexandria", name: "Alexandria", localities: [{ id: "old-town-alex", name: "Old Town", type: "district" }] },
        ]},
        { id: "mn", name: "Minnesota", code: "MN", cities: [
          { id: "minneapolis", name: "Minneapolis", localities: [{ id: "downtown-mpls", name: "Downtown", type: "hub" }] },
          { id: "st-paul", name: "Saint Paul", isCapital: true, localities: [] },
        ]},
        { id: "or", name: "Oregon", code: "OR", cities: [
          { id: "portland-or", name: "Portland", localities: [
            { id: "pearl-district", name: "Pearl District", type: "hub" },
            { id: "alberta", name: "Alberta Arts", type: "district" },
          ]},
          { id: "salem", name: "Salem", isCapital: true, localities: [] },
          { id: "eugene", name: "Eugene", localities: [] },
        ]},
        { id: "ut", name: "Utah", code: "UT", cities: [
          { id: "salt-lake-city", name: "Salt Lake City", isCapital: true, localities: [{ id: "sugar-house", name: "Sugar House", type: "district" }] },
          { id: "provo", name: "Provo", localities: [] },
          { id: "park-city", name: "Park City", localities: [] },
        ]},
        { id: "tn", name: "Tennessee", code: "TN", cities: [
          { id: "nashville", name: "Nashville", isCapital: true, localities: [{ id: "broadway-nash", name: "Broadway", type: "hub" }] },
          { id: "memphis", name: "Memphis", localities: [{ id: "beale-street", name: "Beale Street", type: "hub" }] },
          { id: "knoxville", name: "Knoxville", localities: [] },
        ]},
      ]},
