...
const features = [
  ...
  },
  {
    ...
    description: "Join the conversation on any story or place. Share insights, agree or disagree — your voice matters.",
    highlight: "Community",
  },
  {
    icon: Smartphone,
...
const comparisonData = [
  ...
  { feature: "Open Community Discussions", newstack: true, google: false, inshorts: false, dailyhunt: false, apple: false, perplexity: false },
